...
{
    public partial class ChatReadContext : DbContext
    {
        public ChatReadContext()
        {
        }

        public ChatReadContext(DbContextOptions<ChatReadContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=49.249.56.102;Database=Chat;User Id=sql;password=Optisol@123;Trusted_Connection=false;ApplicationIntent=ReadOnly;MultipleActiveResultSets=true;Integrated Security=False;Persist Security Info=False;TrustServerCertificate=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChatNotification>(entity =>
            {
                ...
                entity.ToView("ChatNotification");
